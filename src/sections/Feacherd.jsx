...
const Feacherd = () => {
    return <>
        <div className='flex flex-col items-center text-sm md:text-lg lg:text-xl xl:text-2xl'>

            <h1 className=' text-lg font-bold border-t-2 border-y-amber-500 pt-3 ms:text-md md:text-lg lg:text-xl xl:text-2xl'>FEATURED</h1>

            <div className=" grid grid-cols-1 gap-20 my-10 md:grid-cols-2 lg:grid-cols-3">
                <div className='px-10 py-5 shadow-xl border-2 border-gray-100 hover:scale-105  flex flex-col items-center justify-center relative '>
